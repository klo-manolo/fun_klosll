...
class klo extends oficial {
	...
	function refrescarStock() {
		return this.ctx.klo_refrescarStock();
	}
}
//// KLO /////////////////////////////////////////////////
/////////////////////////////////////////////////////////////////
...
function klo_refrescarStock()
{
	...
	var codAlmaOrigen:String = cursor.cursorRelation().valueBuffer("codalmaorigen");
	var referencia:String = cursor.valueBuffer("referencia");
	var fechaFin:String = cursor.cursorRelation().valueBuffer("fecha");
	//var costeMedioStock:Number = util.sqlSelect("stocks", "costemediostock", "codalmacen = '" + codAlmaOrigen + "' AND referencia = '" + referencia + "'");
	var costeMedioStock:Number = flfactalma.iface.pub_CMSenUnaFecha(referencia, codAlmaOrigen, fechaFin);
	
	if (!costeMedioStock || costeMedioStock== "")
		costeMedioStock = 0;

	cursor.setValueBuffer("costemediostock", costeMedioStock);
}
//// KLO ///////////////////////////////////////////////////////
/////////////////////////////////////////////////////////////////

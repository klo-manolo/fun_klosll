...
class klo extends oficial {
	...
	function bufferChanged(fN:String) { this.ctx.klo_bufferChanged(fN); }
	function validateForm():Boolean { return this.ctx.klo_validateForm(); }
}
//// KLO /////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////////
...
function klo_bufferChanged(fN:String)
{
	...
	switch (fN) {
		case "referenciadesde":{
			cursor.setValueBuffer("referenciahasta", cursor.valueBuffer("referenciadesde"));
			break;
		}
		default: {
...
function klo_validateForm():Boolean
{
	...
	var agenteTpvDesde:String = this.child("fdbCodAgenteTpvD").value();
	var agenteTpvHasta:String = this.child("fdbCodAgenteTpvH").value();
	
	if (agenteTpvDesde > agenteTpvHasta) {
		MessageBox.critical
				(util.
				translate("scripts",
					  "El agente de TPV inicial debe ser menor que el final"),
       MessageBox.Ok, MessageBox.NoButton, MessageBox.NoButton);
		return false;
	}

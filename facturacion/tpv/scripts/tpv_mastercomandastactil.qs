...
class klo extends oficial {
	...
	function abrirCajon( impresora:String, escAbrir:String ) {
		return this.ctx.klo_abrirCajon( impresora, escAbrir);
	}
}
//// KLO /////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////////
...
@impresora Nombre de la impresora LPR donde está conectado el cajón
*/
function klo_abrirCajon( impresora:String, escAbrir:String )
{
/*	var printer:FLPosPrinter = new FLPosPrinter();
	printer.setPrinterName( impresora );
...
debug("Enviando " + "ESC:" + escAbrir);
	...
	*/
	...
	var baud:String = serialPort.BAUD1200;
	var data:String = serialPort.DATA_8;
	var par:String = serialPort.PAR_NONE;
	var stop:String = serialPort.STOP_1;
	var flow:String = serialPort.FLOW_OFF;
	...
	var sec:String;
   if ( serialPort.open() ) {
		debug("KLO--> Envio esc 27");
		//serialPort.writeText( "ESC: 27" );
		serialPort.putch(27);
		serialPort.close();
	}
debug("KLO--> Hecho 27");

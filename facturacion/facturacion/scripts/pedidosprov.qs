...
class klo extends dtoEspecial {
	...
	function controlStockCabecera():Boolean {
		return this.ctx.klo_controlStockCabecera();
	}
}
//// CONTROL STOCK CABECERA /////////////////////////////////////
/////////////////////////////////////////////////////////////////
...
/////////////////////////////////////////////////////////////////
//// KLO /////////////////////////////////////////////////
function klo_controlStockCabecera():Boolean
{
	debug("klo_controlStockCabecera()");
	...
	//var idStock:Number;
	for (var i:Number = 0; i < arrayAfectados.length; i++) {
		//idStock = util.sqlSelect("stocks", "idstock", "referencia = '" + arrayAfectados[i]["idarticulo"] + "' AND codalmacen = '" + arrayAfectados[i]["codalmacen"] + "'");
		//Esto era cuando estaba articuloscom. if (!flfactalma.iface.pub_actualizarStockPteRecibir(idStock)) {
		if (!flfactalma.iface.pub_actualizarStockPteRecibir(arrayAfectados[i]["idarticulo"], arrayAfectados[i]["codalmacen"], -1)) {
			return false;
		}
	}

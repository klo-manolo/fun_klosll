...
/////////////////////////////////////////////////////////////////
//// KLO ///////////////////////////////////////////////////////
class klo extends proveed 
{
	function klo( context ) { proveed ( context ); }
	function afterCommit_albaranesprov(curAlbaran:FLSqlCursor):Boolean {
		return this.ctx.klo_afterCommit_albaranesprov(curAlbaran);
	}
}
//// KLO ///////////////////////////////////////////////////////
/////////////////////////////////////////////////////////////////
...
/////////////////////////////////////////////////////////////////
//// PAGOSMULTIPROV /////////////////////////////////////////////
class pagosMultiProv extends klo {
	function pagosMultiProv( context ) { klo ( context ); }
// 	function regenerarAsiento(cur:FLSqlCursor, valoresDefecto:Array):Array {
...
/** Asigna los precios del proveedor.
\end */
function klo_afterCommit_albaranesprov(curAlbaran:FLSqlCursor):Boolean
{
	debug("KLO--> afterCommit_albaranesprov");
	...
	var idLinea:Number;
	var referencia:String;
	var codProveedor:String = curAlbaran.valueBuffer("codProveedor");

	var curLineasAlbaranesProv:FLSqlCursor = new FLSqlCursor( "lineasalbaranesprov" );
	curLineasAlbaranesProv.select( "idalbaran = " + curAlbaran.valueBuffer("idalbaran") );

	// Asigna los precios del proveedor.
	while (curLineasAlbaranesProv.next()) {
		referencia = curLineasAlbaranesProv.valueBuffer("referencia");
		idLinea = curLineasAlbaranesProv.valueBuffer("idlinea");
		debug("KLO---> asignaPreciosProveedor: "+referencia);
		flfactalma.iface.pub_asignaPreciosProveedor(referencia,codProveedor,idLinea);
		flfactalma.iface.pub_cambiarUltimoCoste(referencia);
	}

...
class klo extends ivaIncluido {
	...
	function datosLineaAlbaran(curLineaPedido:FLSqlCursor):Boolean {
		return this.ctx.klo_datosLineaAlbaran(curLineaPedido);
	}
}
//// KLO /////////////////////////////////////////////////////
/////////////////////////////////////////////////////////////////
...
@return	True si la copia se realiza correctamente, false en caso contrario
\end */
function klo_datosLineaAlbaran(curLineaPedido:FLSqlCursor):Boolean
{
	with (this.iface.curLineaAlbaran) {
		setValueBuffer("coste", curLineaPedido.valueBuffer("coste"));
	}
